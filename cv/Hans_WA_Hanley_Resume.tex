...
%%%%%%% SourceSansPro OTFs ship with the TeX Live `sourcesanspro' package.
%%%%%%%
...
%%%% Icons
%%%% Font Awesome glyphs are pulled straight out of the OTFs that ship with the
%%%% TeX Live `fontawesome5' package, rather than via \usepackage{fontawesome5}.
%%%% The package's font-descriptor machinery crashes some XeTeX builds (notably
%%%% Tectonic); loading the faces directly with fontspec is equivalent, renders
%%%% identically, and works on every XeLaTeX/LuaLaTeX engine including Overleaf.
%%%% The macro names below match the fontawesome5 ones, so the body is unchanged.
\newfontface\faSolidFace{FontAwesome5Free-Solid-900.otf}
\newfontface\faBrandsFace{FontAwesome5Brands-Regular-400.otf}
\newcommand{\faEnvelope}{{\faSolidFace\symbol{"F0E0}}}
\newcommand{\faGlobe}{{\faSolidFace\symbol{"F0AC}}}
\newcommand{\faPenNib}{{\faSolidFace\symbol{"F5AD}}}
\newcommand{\faLinkedin}{{\faBrandsFace\symbol{"F08C}}}
\newcommand{\faGithub}{{\faBrandsFace\symbol{"F09B}}}
...
{\large \color{UI_blue} Natural Language Processing • AI Safety • Multilingual Representation Learning}\\[6pt]
...
% SUMMARY
% ==========================================================
I build scalable methods to interpret and evaluate large language models, including multilingual representation learning, semantic modeling, and LLM agents for high-fidelity content analysis. My PhD research uncovered latent structure in massive text ecosystems, aligned model behavior across languages and domains, and advanced safer, more reliable AI systems.
...
\subsection*{Stanford University \hfill PhD, Computer Science, 2020-2025 \,|\, MS, Computer Science, 2020-2024}
\subtext{GPA: 4.02; Advisor: Zakir Durumeric; Meta Research PhD Fellow; NSF GRFP; Stanford EDGE Doctoral Fellow}

\subsection*{University of Oxford \hfill MSc, Statistical Science, 2019-2020 \,|\, MSc, Computer Science, 2018-2019}
\subtext{Distinction (Highest Honors); Daniel M.~Sachs Class of 1960 Graduating Scholar at Worcester College}

\subsection*{Princeton University \hfill BSE, Electrical Engineering, 2014-2018}
...
\begin{zitemize}
\item Built and deployed large-scale multilingual and multimodal LLM pipelines modeling content semantics, creator verticals, and interaction behavior across Instagram for downstream recommender systems.
\item Developed LLM-based evaluations and production metrics for political content quality, reply/comment impact, safety and integrity risks, and downstream user experience.
\end{zitemize}

\vspace{-0.25em}
\subsection*{Google Research, Health AI Student Researcher \hfill Summer 2024}
\begin{zitemize}
\item Designed LLM agents for structured querying and high-fidelity reasoning over large clinical datasets, with verification layers for failures under distribution shifts.
\item Built evaluations of accuracy, safety, and adversarial robustness for LLM-mediated medical data interactions.
\end{zitemize}
