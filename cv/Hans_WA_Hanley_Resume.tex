...
% SUMMARY
% ==========================================================
I build scalable methods for interpreting and evaluating large language models, including multilingual representation-learning systems, semantic modeling pipelines, and LLM-based agents for high-fidelity content analysis. My PhD research uncovered latent structure in massive text ecosystems, aligned LLM behaviors across languages and domains, and supported safer, more reliable use of LLM-driven systems.
...
\item Built and researched LLM\-as\-a\-judge evaluators for online assessment of human\-AI interactions in Microsoft Copilot**, measuring task completion, intent satisfaction, reasoning complexity, response quality, and failure modes to surface actionable product\-quality signals for hill-climbing.

\item Led development of LLM\-based classifiers and measurement frameworks connecting production user behavior with offline AI evaluations**, quantifying evaluation representativeness, uncovering gaps in real\-world failure coverage, and driving recommendations to improve evaluation datasets and prioritize testing; findings were incorporated into an executive\-level evaluation strategy presented to Microsoft AI’s CEO.
