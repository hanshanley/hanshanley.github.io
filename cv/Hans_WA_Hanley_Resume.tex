...
\begin{zitemize}
\item Built LLM-as-a-judge evaluators for online assessment of human-AI interactions in Microsoft Copilot, measuring task completion, intent satisfaction, reasoning complexity, response quality, and failure modes to guide product improvement.
\item Led LLM-based classifiers and measurement frameworks linking production behavior to offline AI evaluations, identifying representativeness and failure-coverage gaps; findings shaped dataset priorities and an evaluation strategy presented to Microsoft AI's CEO.
\end{zitemize}
